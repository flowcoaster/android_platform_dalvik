...
static bool disableNativeTainting(const char* appName) {
    ALOGD("checking if native tainting needs to be disabled for %s", appName);
    if (strcmp(appName, "com.android.systemui") == 0
	|| strcmp(appName, "com.android.inputmethod.latin") == 0
	|| strcmp(appName, "com.android.phone") == 0
	|| strcmp(appName, "com.android.launcher") == 0
	|| strcmp(appName, "android.process.media") == 0
	|| strcmp(appName, "com.android.smspush") == 0
	|| strcmp(appName, "android.process.acore") == 0
	|| strcmp(appName, "com.android.settings") == 0
	|| strcmp(appName, "com.android.music") == 0
	|| strcmp(appName, "com.android.musicfx") == 0
	|| strcmp(appName, "com.android.dialer") == 0
	|| strcmp(appName, "com.android.email") == 0
	|| strcmp(appName, "com.android.exchange") == 0
	|| strcmp(appName, "com.android.mms") == 0
	|| strcmp(appName, "com.android.onetimeinitializer") == 0
	|| strcmp(appName, "com.android.providers.calendar") == 0
	|| strcmp(appName, "com.android.voicedialer") == 0
	|| strcmp(appName, "com.android.calendar") == 0
	|| strcmp(appName, "com.android.deskclock") == 0
	|| strcmp(appName, "com.android.browser") == 0
	|| strcmp(appName, "com.android.gallery3d") == 0		//called during adb install
	|| strcmp(appName, "com.android.keychain") == 0			//called during adb install
	|| strcmp(appName, "com.android.defcontainer") == 0		//called during adb install
	|| strcmp(appName, "com.svox.pico") == 0			//called during adb install
    ...
    || strstr(appName, "com.google.") != NULL
    || strstr(appName, "com.android.") != NULL
    || strstr(appName, "android.content.") != NULL ) {
...
static pid_t forkAndSpecializeCommon(const u4* args, bool isSystemServer)
{
...
#ifdef WITH_TAINT_TRACKING
    ALOGD("seInfo=%s, niceName=%s", seInfo, niceName);
    bool disableTaint = niceName == 0 ? true : disableNativeTainting(niceName);
#endif
    ...
    if (pid == 0) {
        ...
        gDvm.zygote = false;
#ifdef WITH_TAINT_TRACKING
	ALOGD("Zygote calling dvmInitAfterZygote(%d)", disableTaint);
        if (!dvmInitAfterZygote(disableTaint)) {
#else
